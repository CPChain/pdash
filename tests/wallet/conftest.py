...
def strans(contract_name):
    ...
    trans_obj = chain.agent.SellerAgent(chain.utils.default_w3, contract_name=contract_name)
    return trans_obj
...
def ptrans(contract_name):
    ...
    trans_obj = chain.agent.ProxyAgent(chain.utils.default_w3, contract_name=contract_name)
    return trans_obj