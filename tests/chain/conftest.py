...
def btrans(contract_name):
    ...
    trans_obj = chain.agents.BuyerAgent(buyer_web3, contract_name=contract_name)
    return trans_obj
...
def strans(contract_name):
    ...
    trans_obj = chain.agents.SellerAgent(chain.utils.default_web3, contract_name=contract_name)
    return trans_obj
...
def ptrans(contract_name):
    ...
    trans_obj = chain.agents.ProxyAgent(chain.utils.default_web3, contract_name=contract_name)
    return trans_obj
