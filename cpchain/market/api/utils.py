...
if __name__ == '__main__':
    ...
    # sign:MEYCIQC2U2WoOsxew+E9Hy0rTg6+Rh8v3GNsnpXMGdJ9/sBLcAIhAKCbAPhwqJP86DjVMibg5rNU4pYABEf2JD5GBLSC4OGJ
    # data:qZaQ6S

    private_key_string = ""
    public_key_string = "MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEVWPo4T5VbYn391ZahHf9HgjRsox6k3Kix7HP4PbIWlOvkQ9KZFMHk34PoMNircsbC4FysZKVbAl8ENFVf2GyDA=="
    data = "qZaQ6S"
    expected_sign = "MEYCIQC2U2WoOsxew+E9Hy0rTg6+Rh8v3GNsnpXMGdJ9/sBLcAIhAKCbAPhwqJP86DjVMibg5rNU4pYABEf2JD5GBLSC4OGJ"

    print("new_signature 1 is:")
    data = "qZaQ6S"
