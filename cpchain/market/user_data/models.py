...
class BuyerFileInfo(models.Model):
    ...
    """
    public_key = models.CharField(_('publicKey'), max_length=200)
    order_id = models.IntegerField('generate by chain', null=True)#* order_id -> is_downloaded
